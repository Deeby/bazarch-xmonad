...
myWorkspaces :: [String]
myWorkspaces = clickable . (map xmobarEscape) $ ["\61612","\61508","\61728","\61574","\61502","\61501","\61705","\61832","\61564", "\62150"]
    where
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
  ...
  , ((modMask, xK_d), spawn  "dmenu_run -i -nb '#191919' -nf '#fea63c' -sb '#fea63c' -sf '#191919' -fn 'NotoMonoRegular:bold:pixelsize=16'" )
  ...
  , ((modMask, xK_F10), spawn $ "xfce4-terminal" )
  ...
  , ((modMask .|. shiftMask , xK_d ), spawn $ "rofi -show run")
  ...
  -- , ((controlMask .|. mod1Mask , xK_s ), spawn $ "xfce4-terminal")
  ...
  , ((controlMask .|. mod1Mask , xK_Return ), spawn $ "xterm")
