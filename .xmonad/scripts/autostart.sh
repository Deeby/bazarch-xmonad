...
run trayer --edge top --align right --SetDockType true --SetPartialStrut false --expand true --height 20 --transparent false --iconspacing 7  --alpha 0 --tint 0x000000 --widthtype request --monitor 1 &
